...
console.log(
  `Meu nome é ${name3} e sobrenome é ${surName3} e tenho ${age2} anos de idade.`
)
...
var result = `Tenho uma ${text} de R$:${value} e vou receber mais R$:125, ou seja vou ficar com um total de R$:${
  value + 125
}`
